...
import { SigninValidation, SignupValidation } from '../formsValidation'
      ...
      <Form {...form}>
        <div className="sm:w-100 flex-center flex-col pl-1.5 pr-1.5">
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-3 w-full mt-4">
            ...
            <Button type='button' className='border-gray-300 border text-black text-[15px] bg-transparent px-3 py-5 w-full transition-all duration-200 hover:text-white hover:bg-black cursor-pointer'><img src={google_logo} className='w-6 h-6 mr-1' />Sign In with Google</Button>
